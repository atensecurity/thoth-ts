...
type EnforceConfig = Required<Pick<ThothConfig, "agentId" | "approvedScope" | "tenantId" | "userId" | "enforcement" | "apiKey" | "apiUrl" | "stepUpTimeoutMinutes" | "stepUpPollIntervalMs" | "environment">> & Pick<ThothConfig, "sessionIntent" | "policyContext" | "enforcementTraceId" | "purpose" | "dataClassification" | "taskContext"> & Pick<ThothConfig, "identityBinding">;
